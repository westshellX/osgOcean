...
uniform sampler2D  osgOcean_WaterWaveMap;
...
void main( void )
{
	// In object space
	vVertex = gl_Vertex;
	vec4 water_tilec=gl_TexCoord[0];
	float waveHeight=texture(osgOcean_WaterWaveMap,water_tilec.st).r;
	vVertex.z+=waveHeight;
